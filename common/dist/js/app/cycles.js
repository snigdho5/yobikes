$(document).ready(function () {
    ...
    $(document).on('keyup', '#name', function () {
        ...
        if (name != '') {
            $.ajax({
                type: "POST",
                url: BASE_URL + 'duplicate_check_cycle',
                data: {
                    name: name
                },
                ...
                success: function (d) {
                    if (d.if_exists == 1) {
                        $('#chk_name').show();
                        $('#chk_name').html('<i class="icofont-close-squared-alt"></i> Cycle already exists..!!');
                        $("#chk_name").css("color", "red");
                        return false;
                    } else {
                        $('#chk_name').show();
                        $('#chk_name').html('<i class="icofont-tick-boxed"></i> Cycle available.');
