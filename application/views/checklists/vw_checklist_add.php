					...
					<div class="col-12">
						<div class="card">
							...
							<form class="form-horizontal" id="create_form" autocomplete="off">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'checklists'; ?>'"><?php echo $page_title; ?>s List</button></h4>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<input type="number" class="form-control" id="carton" name="carton" placeholder="Carton.." autocomplete="off" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<input type="number" class="form-control" id="tyre" name="tyre" placeholder="Tyre.." autocomplete="off" required>
										</div>

										<label for="rim" class="col-sm-1 text-right control-label col-form-label">Rim (Pair)</label>
										<div class="col-sm-5">
											<input type="number" class="form-control" id="rim" name="rim" placeholder="Rim (Pair).." autocomplete="off" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<input type="number" class="form-control" id="busket" name="busket" placeholder="Busket.." autocomplete="off" required>
										</div>

										<label for="frame" class="col-sm-1 text-right control-label col-form-label">Frame</label>
										<div class="col-sm-5">
											<input type="number" class="form-control" id="frame" name="frame" placeholder="Frame.." autocomplete="off" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<input type="number" class="form-control" id="mudguard" name="mudguard" placeholder="Mudguard (Pair).." autocomplete="off" required>
										</div>

										<label for="sit" class="col-sm-1 text-right control-label col-form-label">Sit</label>
										<div class="col-sm-5">
											<input type="number" class="form-control" id="sit" name="sit" placeholder="Sit.." autocomplete="off" required>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-5">
											<input type="number" class="form-control" id="handle" name="handle" placeholder="Handle.." autocomplete="off" required>
										</div>

										<label for="carrier" class="col-sm-1 text-right control-label col-form-label">Carrier</label>
										<div class="col-sm-5">
											<input type="number" class="form-control" id="carrier" name="carrier" placeholder="Carrier.." autocomplete="off" required>
										</div>
									</div>
