				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							?>
							<form class="form-horizontal" id="create_company_form" autocomplete="off">
								<div class="card-body">
									<h4 class="card-title">Create New <?php echo $page_title; ?> <button type="button" class="btn badge badge-pill badge-success" onclick="location.href='<?php echo base_url() . 'companies'; ?>'"><?php echo $page_title; ?>s List</button></h4>

									<div class="form-group row">
										<label for="name" class="col-sm-3 text-right control-label col-form-label">Comapany Name</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" id="name" name="name" placeholder="Comapany Name.." autocomplete="off">
								...
								<div class="border-top">
									<div class="card-body">
										<button type="submit" id="company_btn_submit" class="btn btn-primary company_btn_submit">Submit</button>
									</div>
								</div>
							</form>
						</div>
